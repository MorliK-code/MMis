...
class PromptRegistry:
    ...
    DEFAULTS: dict[str, PromptEntry] = {
        ...
        "system.persona.default": PromptEntry("system.persona.default", "system/personality_default.txt"),
        "system.persona.flirty": PromptEntry("system.persona.flirty", "system/personality_flirty.txt"),
        "system.persona.strict": PromptEntry("system.persona.strict", "system/personality_strict.txt"),
        "system.style.default": PromptEntry("system.style.default", "system/style_default.txt"),
        "system.style.flirty": PromptEntry("system.style.flirty", "system/style_flirty.txt"),
        "system.style.strict": PromptEntry("system.style.strict", "system/style_strict.txt"),
        "system.style.supportive": PromptEntry("system.style.supportive", "system/style_supportive.txt"),
        "system.rules.default": PromptEntry("system.rules.default", "system/rules_default.txt"),
