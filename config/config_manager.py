...
LEGACY_KEY_MAP: dict[str, str] = {
    ...
    "host": "api.host",
    "port": "api.port",
    "api_access_lock_enabled": "api.access_lock.enabled",
    "api_access_key_hash": "api.access_lock.key_hash",
    "api_access_deny_status": "api.access_lock.deny_status",
    "api_access_allow_ping_without_key": "api.access_lock.allow_ping_without_key",
    ...
    "cache_dir": "memory_core.cache_dir",
    "log_dir": "memory_core.log_dir",
...
_DEPRECATED_DOTTED_KEYS: tuple[str, ...] = (
    ...
    # Legacy memory.* keys (backward compatibility)
    "memory.memory_dir",
    "memory.cache_dir",
    "memory.log_dir",
    "memory.db_path",
    "memory.chat_recall_results",
    "memory.chat_events_limit",
    "memory.chat_proofread",
    "memory.chat_proofread_strict",
)
